...
Room.create(price_per_night: 65, capacity: 3, hotel_id: 1)
Room.create(price_per_night: 105, capacity: 2, hotel_id: 1)
Room.create(price_per_night: 205, capacity: 2, hotel_id: 1)
Room.create(price_per_night: 55, capacity: 2, hotel_id: 2)
Room.create(price_per_night: 85, capacity: 3, hotel_id: 2)
Room.create(price_per_night: 125, capacity: 2, hotel_id: 2)
Room.create(price_per_night: 255, capacity: 2, hotel_id: 2)
Room.create(price_per_night: 345, capacity: 2, hotel_id: 3)
Room.create(price_per_night: 445, capacity: 2, hotel_id: 3)
